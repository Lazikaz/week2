...
function canWeDeliver(zipCode){
    if(deliveryAreaZipCodes.includes(zipCode) === true){
        return("You are elegible for delivery.")
    }else{
        return("You are not elegible for delivery.")
    }
}
...
function canWeDeliverTwo(zipCode){
    for(i = 0; i < deliveryAreaZipCodes.length; i++){
        if(zipCode === deliveryAreaZipCodes[i]){
            return ("You are elegible for delivery.")
        }else if(zipCode != deliveryAreaZipCodes[i] && i === deliveryAreaZipCodes.length - 1){
            return ("You are not elegible for delivery.")
        }
    }
}
...
console.log(canWeDeliver(11))
console.log(canWeDeliverTwo(111))
